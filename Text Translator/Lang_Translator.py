#Github_link www.github.com/pramod-sanghavi/
#instagram Page @pyadda
#telegram Channel @pythonadda
...
label3=tk.Label(win,text="Project by >>>instagram @pyadda",fg="green")
label3.grid(row=4,column=0)

win.mainloop()
#for more project follow my insta page @pyadda >>>> python adda